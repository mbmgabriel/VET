...
function ClassTask() {
  ...
  const toggle = (e, item, item1, item2, item3, item4, item5) =>{
    setTaskName(item)
    ...
    <ClassSideNavigation>
      ...
      <HeaderTask onSearch={onSearch} module={module} getTaskModule={getTaskModule} onRefresh={() => getClassInfo()}/>
        ...
        {module.map((item, index) =>{
          ...
          <EditTask sequenceNo={sequenceNo} setSequenceNo={setSequenceNo} setRate={setRate} rate={rate} moduleName={moduleName} taskId={taskId} setTaskId={setTaskId} instructions={instructions} setInstructions={setInstructions} taskName={taskName} setTaskName={setTaskName} setModal={setModal} moduleId={moduleId} editTask={editTask} toggle={toggle} modal={modal} module={module} getTaskModule={getTaskModule} />
