    ...
    <MainContainer activeHeader={'classes'} loading={loading}>
      ...
      <div className='page-container'>
        <div className='containerpages'>
          {user.isStudent &&
          <>
          <StudentClassListHeader getClassesStudent={getClassesStudent} setJoinClassesModal={setJoinClassesModal} onSearch={onSearch} getPendingClasses={getPendingClasses}  joinClassesToggle={joinClassesToggle} joinClassestModal={joinClassestModal} />
